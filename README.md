<h2 align="center">박건우 (Park Geonwoo)</h2>
...
사람들의 일상이 조금 더 나아지도록 돕는 기술을 만들고 싶은 개발자 박건우입니다.  
배우는 것을 좋아해 꾸준히 학습하려고 노력하며, 같은 목표를 가진 사람들과 함께 성장하고 우리가 만든 것으로 누군가에게 도움이 될 때 가장 큰 보람을 느낍니다.

## Experience

- **디지엠유닛원 (2025.07–2026.01)**: 자사 서비스 개발 및 LG 공통 업무 플랫폼 AI 챗봇 서비스 개발
- **스마일게이트 윈터 데브 (2025.01–2025.03)**: 팀 단위 실전 프로젝트 설계·구현·릴리즈 경험
- **크래프톤 정글 (2024.07–2024.11)**: 전산학 학습 및 실시간 코드 리뷰 도구 개발
- **퓨처 이모텍 단기 인턴 (2023.01.02–2023.01.20)**: 탄소중립 시장 조사·분석 및 보고서 작성
- **아티피셜 소사이어티 단기 인턴 (2022.07.04–2022.07.22)**: AI 시선추적 기반 서비스에서 데이터 수집·전처리 및 모델 개선 지원

## Awards

- **조선대학교 총장배 모범상 (2024.02.18)**: 학부 졸업 시 수상
- **ICICT 2023 (2023.03–2023.07)**: AI 기반 의료영상처리 알고리즘 연구로 포스터 우수상

## Tech Stack

- **프론트엔드**: React, Next.js, TypeScript, JavaScript(ES6+), HTML5, CSS3
- **백엔드**: Express.js, MySQL, Flask, FastAPI
- **상태 / 데이터**: Zustand, TanStack Query(React Query)
- **스타일링**: Tailwind CSS, Styled-Components, SCSS
- **테스트**: Jest, Cypress
- **클라우드 / 인프라**: AWS (Bedrock, Lambda, API Gateway, DynamoDB, S3, Knowledge Base)

## Notes

- [Daily Dev Log](https://github.com/pigpgw/daily-dev-log): 개인 기록용 TIL/노트
